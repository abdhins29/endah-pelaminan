...
<br>
  <div class="container">
    <center>
      <h2 class="page-header">Pemesanan Anda Berhasil</h2>
    </center>

  <div class="col-md-12">
    <table class="table table-bordered" style="background:ghostwhite;color:dimgrey">
      <tr>
        <td align="center" style="background:dimgrey;color:white;"><i class="icon-info"></i> Pemesanan Anda Telah Berhasil</td>
      </tr>
      <tr>
        <td>
          <h2 align="center"> --- Segeralah Melakukan Pembayaran --- </h2>
          <hr>
          <h5 align="center"> <a href="bukti.php?id=<?php echo $id_pesan; ?>" target="_blank();" class="btn btn-info" style="border:1px solid dimgrey"><i class="icon-print"></i> Cetak Bukti Anda</a></h5>
        </td>
      </tr>
      <tr>
